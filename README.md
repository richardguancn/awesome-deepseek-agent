...
| **DYWorker** | Local AI work assistant for everyday office tasks — reads documents, drafts files, generates Word/Excel output, and operates desktop apps, all on your machine. | [Guide](./docs/dyworker.md) |
